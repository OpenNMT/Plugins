...
namespace OpenNMT
{
    ...
    [TranslationProviderWinFormsUi(
        Id = "OpenNmtProviderWinFormsUI",
        Name = "OpenNmtProviderWinFormsUI",
        Description = "OpenNmtProviderWinFormsUI")]
    #endregion
    public class OpenNmtProviderWinFormsUI : ITranslationProviderWinFormsUI
    {
        ...
        public bool SupportsTranslationProviderUri(Uri translationProviderUri)
        {
            ...
            return String.Equals(translationProviderUri.Scheme, OpenNmtProvider.ListTranslationProviderScheme, StringComparison.CurrentCultureIgnoreCase);
        }
